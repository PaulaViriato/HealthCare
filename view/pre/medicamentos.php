...
foreach ($tabelas as $tab){
	if (intval($tab->get_type()) == 0){
		$data = $tab->get_MEDTAB()->get_data();
		if (strtotime($data) > strtotime($curr_data)){
			$medtab = $tab->get_MEDTAB();
			$curr_data = $data;
		}
	}
}
...
<body>
	<div id="wrapper">
			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<form style="height:0px;margin-bottom:0px;" enctype="multipart/form-data" method="POST" action="medicamentos.php">
		...
		<div class="main">
					...
					<div class="row">
						<div class="panel">
							<div class="panel-heading" style="text-align:center;">
								...
								Aguarde a disponibilização de uma tabela de medicamentos pela operadora!
							</div>
						</div>
					</div>
				</div>
			...
			<div id="painel_medicamento" class="main-content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="panel">
								...
								<div id="med_detalhes" style="padding-left:25px;padding-right:25px;margin-bottom:15px;">
									<b>Nome: </b><span><?php echo $medtab->get_nome(); ?></span><br>
									<b>Data de Criação: </b><span><?php echo $medtab->get_data(); ?></span><br>
									<input id="idmedtab" type="hidden" name="id" value="<?php echo $medtab->get_id(); ?>" required/>
								</div>
								<div id="search-panel">
									...
									<div class="panel-body" style="width:100%;padding-top:0px;padding-bottom:10px;">
										<div class="btn-group" style="margin-right:1%;width:20%;">
											...
											<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
												...
												<li><a tabindex="4" onclick="modifyDropdownMed('4')">Todos</a></li>
											</ul>
										</div>
	...
	<script type="text/javascript">
		...
		function modifyDropdownMed (index){
			...
			document.getElementById ("searchtxtmed").disabled = false;
			...
			if (parseInt(index) == 4){
				$('#strcampomed').html ("Todos &nbsp<span class=\"caret\"></span>");
				document.getElementById ("searchtxtmed").disabled = true;
			}
		}

		function searchMed (){
			if (((parseInt(document.getElementById("searchindexmed").value) == -1)||
				(document.getElementById("searchtxtmed").value == ""))&&(parseInt(document.getElementById("searchindexmed").value) != 4)){
		...
		function openVisualizarMedicamento(id){

...
if (isset($_POST["permitexec"])){
	if (strcasecmp ("".$_POST["permitexec"], "true") == 0){
		if (intval($_POST["typeoperation"]) == 1){
			if (isset($_POST["id"])){ $DAOMedicamento->delete($_POST["id"]); }
		}
	}
}
?>
...
<body>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="medicamentos.php" class="active"><i class="lnr lnr-drop"></i> <span>Medicamentos</span></a></li>
									...
									<div class="panel-body" style="width:100%;padding-top:0px;padding-bottom:10px;">
										<div class="btn-group" style="margin-right:1%;width:20%;">
											...
											<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
												...
												<li><a tabindex="1" onclick="modifyDropdown('1')">Substância</a></li>
												<li><a tabindex="2" onclick="modifyDropdown('2')">Produto</a></li>
												<li><a tabindex="3" onclick="modifyDropdown('3')">Laboratório</a></li>
										...
										<table id="table-materiais" class="table table-striped table-bordered">
											<thead>
												<tr>
													...
													<th style="width:19%;font-size:14px;">Produto</th>
													<th style="width:19%;font-size:14px;">Laboratório</th>
									...
									<div class="panel-footer">
										<div class="row">
											<div class="col-md-12" align="center">
												<button data-toggle="modal" data-target="#modalAguarde" class="btn btnlarge btn-success"> Cadastrar Medicamento </button>
											</div>
										</div>
									</div>
								</div>
	...
	<div id="modalExcluir" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<form enctype="multipart/form-data" method="POST" action="medicamentos.php">
					...
					<div class="modal-body">
						<input id="idmedicamentoexcl" type="hidden" name="id" required/>
	...
	<script type="text/javascript">
		...
		function modifyDropdown (index){
			...
			if (parseInt(index) == 1){ $('#strcampo').html ("Substância &nbsp<span class=\"caret\"></span>"); }
			if (parseInt(index) == 2){ $('#strcampo').html ("Produto &nbsp<span class=\"caret\"></span>"); }
			if (parseInt(index) == 3){ $('#strcampo').html ("Laboratório &nbsp<span class=\"caret\"></span>"); }
			if (parseInt(index) == 4){
		...
		function search (){
			...
			if (index == 1){ text = "UPPER(substancia) LIKE '%"+txtsc.toUpperCase()+"%'"; }
			if (index == 2){ text = "UPPER(produto) LIKE '%"+txtsc.toUpperCase()+"%'"; }
			if (index == 3){ text = "UPPER(laboratorio) LIKE '%"+txtsc.toUpperCase()+"%'"; }
